                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('update.portfolio') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="portfolio_name" value="{{ $portfolio->portfolio_name }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="portfolio_title" value="{{ $portfolio->portfolio_title }}"
                                            class="form-control" type="text" id="example-text-input">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="show_image" class="rounded avatar-lg"
